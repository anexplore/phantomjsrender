...
public class HttpClientFactory {
    ...
    public CloseableHttpClient createHttpClient(Credentials credentials, int connectionTimeout,
            int socketTimeout) {
        ...
        HttpClientBuilder builder =
                HttpClientBuilder
                        ...
                        .setDefaultRequestConfig(
                                createRequestConfig(connectionTimeout, socketTimeout))
    ...
    public HttpClient getGridHttpClient(int connectionTimeout, int socketTimeout) {
        ...
        return HttpClientBuilder.create().setConnectionManager(gridClientConnectionManager)
                .setRedirectStrategy(new MyRedirectHandler()).setDefaultSocketConfig(socketConfig)
                .setDefaultRequestConfig(requestConfig).setRoutePlanner(createRoutePlanner())
                .build();
    }

    protected SocketConfig createSocketConfig(int socketTimeout) {
        return SocketConfig.custom().setSoReuseAddress(true).setSoTimeout(socketTimeout).build();
    }
